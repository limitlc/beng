...
import com.paxw.fly.view.MyBengView;

public class mainActivity extends BaseActivity{
	
	//整个游戏的 view
	private MyBengView mMyBengView;
	...
	public void onCreate(Bundle savedInstanceState){
        ...
        mMyBengView =new MyBengView(this);
        setContentView(mMyBengView);
   ...
   //     mByronleeTeeterView =(ByronleeTeeterView) findViewById(R.id.game_body);
		...
		mSensorEventListener = new SensorEventListener() {  
			...
			public void onSensorChanged(SensorEvent e) {
				mMyBengView.handleMoving(e.values[SensorManager.DATA_X]);
			}
