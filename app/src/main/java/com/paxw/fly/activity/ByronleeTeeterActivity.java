...
public class ByronleeTeeterActivity extends BaseActivity  implements OnClickListener  {
    /** Called when the activity is first created. */
	private SharedPreferences mBaseSettings;
	@Override
    public void onCreate(Bundle savedInstanceState) {
		AdManager.getInstance(this.getApplicationContext()).init("08e069fc8cc279c1", "b921eb16ba2194d0",false);
		SpotManager.getInstance(this.getApplicationContext()).loadSpotAds();
